            ...
            <div class="space-y-4 border-0">
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password"
                        class="appearance-none rounded-md relative block w-full px-3 py-2 mt-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                ...
                <div class="flex items-center justify-end">
                    <div class="text-sm">
                        <a href="{{ route('forgot-password') }}" class="font-medium text-[#334b8c] cursor-pointer">
